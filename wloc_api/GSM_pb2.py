...
_CELLRESPONSE1_LOCATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data11', full_name='CellResponse1.Location.data11', index=4,
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data12', full_name='CellResponse1.Location.data12', index=5,
...
_CELLRESPONSE22_LOCATION = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data11', full_name='CellResponse22.Location.data11', index=4,
      number=11, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data12', full_name='CellResponse22.Location.data12', index=5,
      number=12, type=3, cpp_type=2, label=1,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
...
_CELLRESPONSE22 = _descriptor.Descriptor(
  ...
  fields=[
    ...
    _descriptor.FieldDescriptor(
      ...
      serialized_options=None, file=DESCRIPTOR,  create_key=_descriptor._internal_create_key),
    _descriptor.FieldDescriptor(
      name='data7', full_name='CellResponse22.data7', index=6,
...
MyCell = _reflection.GeneratedProtocolMessageType('MyCell', (_message.Message,), {
  'DESCRIPTOR' : _MYCELL,
  '__module__' : 'GSM_pb2'
...
CellReqToApple1 = _reflection.GeneratedProtocolMessageType('CellReqToApple1', (_message.Message,), {
...
CellReqToApple25 = _reflection.GeneratedProtocolMessageType('CellReqToApple25', (_message.Message,), {
...
CellResponse1 = _reflection.GeneratedProtocolMessageType('CellResponse1', (_message.Message,), {
...
CellResponse22 = _reflection.GeneratedProtocolMessageType('CellResponse22', (_message.Message,), {
...
CellInfoFromApple22 = _reflection.GeneratedProtocolMessageType('CellInfoFromApple22', (_message.Message,), {
...
CellInfoFromApple1 = _reflection.GeneratedProtocolMessageType('CellInfoFromApple1', (_message.Message,), {
